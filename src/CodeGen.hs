...
transMips instr strLit fltLit = do fillData strLit fltLit
                                   ...
                                   return ([".data"] ++ strBuf ++ strBufSize ++ powOvrFlwMsg ++ powNegExpMsg ++ floatOne ++ floatZero ++ dataList ++ [".text", "main:"] ++ code2 ++ ["j program_end"] ++ readFun ++ printFun ++ putLineFun ++ powIntFun ++ powFloatFun ++ powOverflow ++ programEnd)
