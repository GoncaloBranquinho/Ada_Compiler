...
transMips instr strLit fltLit = do fillData strLit fltLit
                                   ...
                                   return ([".data"] ++ strBuf ++ strBufSize ++ powOvrFlwMsg ++ powNegExpMsg ++ floatOne ++ floatZero ++ dataList ++ [".text", "main:"] ++ code2 ++ readFun ++ printFun ++ powIntFun ++ powFloatFun ++ powOverflow ++ exitProgram)
